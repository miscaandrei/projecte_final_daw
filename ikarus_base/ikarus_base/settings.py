...
DATABASES = {
    'default': {
        ...
        'NAME': 'ikarus',                                       # Or path to database file if using sqlite3.
...
SECRET_KEY = 'eciewooj3kjj=mf)#0k33vh58cs0#(rl&5)$e1a84f0$*%uh(d'
...
ROOT_URLCONF = 'ikarus_base.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'ikarus_base.wsgi.application'
